/* [project]/node_modules/@mantine/core/styles.css [app-ssr] (css) */
*, 
*::before, 
*::after {
...
/* [project]/node_modules/@mantine/dates/styles.css [app-ssr] (css) */
.m_468e7eda {
  padding-top: 0;
  padding-bottom: 0;
  -webkit-appearance: none;
...
@media (hover: hover) {
  [data-mantine-color-scheme='light'] .m_f6645d97:hover:where(:not([data-disabled], :disabled)), 
  [data-mantine-color-scheme='light'] .m_2351eeb0:hover:where(:not([data-disabled], :disabled)) {
    background-color: var(--mantine-color-gray-0);
  }
...
@media (hover: none) {
  [data-mantine-color-scheme='light'] .m_f6645d97:active:where(:not([data-disabled], :disabled)), 
  [data-mantine-color-scheme='light'] .m_2351eeb0:active:where(:not([data-disabled], :disabled)) {
    background-color: var(--mantine-color-gray-0);
  }
...
/* [project]/node_modules/mantine-react-table/styles.css [app-ssr] (css) */
...
/*# sourceMappingURL=node_modules_9f5db7._.css.map*/
